...
module.exports = {
  scripts: {
    build: {
      script: `browserify -e browser-entry.js --plugin ./scripts/dedefine --ignore "./lib/esm-utils.js" --ignore 'fs' --ignore 'glob' --ignore 'path' --ignore 'supports-color' --ignore chokidar -o mocha.js`,
